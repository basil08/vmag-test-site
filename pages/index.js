      ...
      <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark py-1">
          <div class="container px-5">
            <a class="navbar-brand" href="#">V O I C E 
            <span class="text-warning small px-2"> always upward</span>
            </a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav me-auto mb-2 mb-md-0 float-right px-3">
                <li class="nav-item">
                  <a class="nav-link" aria-current="page" href="#voice">About</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#want-to-be-featured">Get Featured</a>
                </li>
                <li class="nav-item">
        ...
        <main>
          ...
          {/* What is Voice? */}
          <div class="p-5 mb-4 bg-light rounded-3" id="voice">
            <div class="container-fluid py-5">
              <h1 class="display-5 fw-bold"> ☀️ What is Voice?</h1>
              ...
              <button class="btn btn-primary btn-lg" type="button">Download latest issue</button>
            </div>
          </div>
          ...
          <div class="container col-xxl-8 px-4 py-5">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5" id="want-to-be-featured">
              <div class="col-lg-7">
                <h1 class="display-5 fw-bold lh-1 mb-3" >✍️ Want to be featured?</h1>
                <p class="lead fs-4">Voice is a medium of expression for thinkers and free spirits.</p>
                <p class="lead">We welcome articles, fictions, poetries, and even artworks. Have a look at our <a href="">Code of Conduct For Content Creators</a> to maximize your chances of being featured!</p>
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                  <button type="button" class="btn btn-primary btn-lg px-4 me-md-2">Email us!</button>
                </div>
              </div>
          ...
          <div class="p-5 mb-4 bg-light rounded-3" id="showcase">
            <div class="container-fluid py-5">
              <h1 class="display-5 fw-bold">📢 Showcase your skills</h1>
              <p class="lead fs-4 col-lg-6">
              ...
              <button class="btn btn-primary btn-lg" type="button">Yes, count me in!</button>
            </div>
          </div>

          {/* Suppport */}
          <div class="px-4 py-5 my-5 text-center" id="support">
            ...
            <div class="col-lg-6 mx-auto">
              ...
              <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <button type="button" class="btn btn-primary btn-lg px-4 gap-3">PayPal</button>
                <button type="button" class="btn btn-warning btn-lg px-4">Bitcoin</button>
              </div>
            </div>
          </div>
          ...
          <div class="p-5 mb-4 bg-light rounded-3">
            <div class="container-fluid py-5">
              <h1 class="display-5 fw-bold">📡 Connect with us</h1>

              {/* Check grammar? */}
              <p class="col-md-8 fs-4 lead">Love Voice? We do too! Our work is for the teenage community and your cheers keeps us going. Tell us how you feel about Voice!</p>
          ...
          <div class="row">
            ...
            <div class="col-6 col-md">
              ...
              <ul class="list-unstyled text-small">
                <li><a class="link-secondary" href="#want-to-be-featured">Get Featured</a></li>
                <li><a class="link-secondary" href="#showcase">For Artists</a></li>
                <li><a class="link-secondary" href="#showcase">For Designers</a></li>
                <li><a class="link-secondary" href="#support">Support</a></li>
              </ul>
            </div>
            <div class="col-6 col-md">
              <h5>Resources</h5>
              <ul class="list-unstyled text-small">
                <li><a class="link-secondary" href="#">CoC For Content Creators</a></li>
                <li><a class="link-secondary" href="#">Terms</a></li>
                <li><a class="link-secondary" href="#">Legal</a></li>
              </ul>
            </div>
            <div class="col-6 col-md">
              <h5>Socials</h5>
